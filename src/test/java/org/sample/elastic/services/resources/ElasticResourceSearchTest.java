...
public class ElasticResourceSearchTest {
    ...
    public void setUp() throws Exception {
        ...
        esResource.createDocument(indexName, "product", "{name:\"led tv\"}");
    }
    ...
    public void testSearch() throws Exception {
        Response response = esResource.search(indexName, "product", "lcd", 0, 20, "", 0, 0);
